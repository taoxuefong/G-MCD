...
parser.add_argument('--epochs', default=30, type=int, metavar='4N',
...
def main():
    ...
    # Data loading code
    data = dataset.__dict__[args.data](root='D:\\reid\data\MSMT17', part='train', size=(args.height, args.width),
    ...
    #tl_criterion = loss.TripletLoss(margin=1.0, num_instances=4).cuda()
    #l_criterion = nn.CrossEntropyLoss().cuda()
...
if __name__ == '__main__':
    #python -W ignore supervised_train.py --data MSMT17 --gpu 0,1 --exp-name snapshot --batch-size 42 --lr 0.0001 
    if args.debug:
        remote_debug()
    main()
